...
def generate_report(raw_info):
    ...
    2. **标明出处**：在提到具体的趋势、爆品或政策时，**千万不要使用 Markdown 的超链接格式（例如 [text](url)）**，因为飞书支持不好。请直接在对应段落的末尾另起一行，以纯文本形式写上：“👉 来源：原始URL”。
    3. **降维打击/破圈思维**：如果今天抓取到的【美妆直接相关】资讯较少，请自动提炼抓取到的【泛 TikTok 热门话题】或【整体跨境电商政策大新闻】作为补充，并用一两句话点拨跨境卖家可以如何蹭这个热点。
    4. 分为三个核心板块：
